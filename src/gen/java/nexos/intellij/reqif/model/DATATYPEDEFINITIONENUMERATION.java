...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:DATATYPE-DEFINITION-ENUMERATION interface.
 */
public interface DATATYPEDEFINITIONENUMERATION extends DomElement {
	...
	/**
	 * Returns the value of the SPECIFIED-VALUES child.
	 * @return the value of the SPECIFIED-VALUES child.
	 */
	@NotNull
