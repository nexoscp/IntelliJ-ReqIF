...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:DATATYPE-DEFINITION-INTEGER interface.
 */
public interface DATATYPEDEFINITIONINTEGER extends DomElement {
	...
	@NotNull
	@Required
	GenericAttributeValue<Integer> getMAX();
	...
	@NotNull
	@Required
	GenericAttributeValue<Integer> getMIN();
