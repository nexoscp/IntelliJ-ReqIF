...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:ATTRIBUTE-VALUE-BOOLEAN interface.
 */
public interface ATTRIBUTEVALUEBOOLEAN extends DomElement {
	...
	@NotNull
	@Required
	GenericAttributeValue<Boolean> getTHEVALUE();
