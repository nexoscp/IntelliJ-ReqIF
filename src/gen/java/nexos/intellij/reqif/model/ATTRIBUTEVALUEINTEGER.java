...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:ATTRIBUTE-VALUE-INTEGER interface.
 */
public interface ATTRIBUTEVALUEINTEGER extends DomElement {
	...
	@NotNull
	@Required
	GenericAttributeValue<Integer> getTHEVALUE();
