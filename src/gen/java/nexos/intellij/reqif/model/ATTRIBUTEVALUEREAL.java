...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:ATTRIBUTE-VALUE-REAL interface.
 */
public interface ATTRIBUTEVALUEREAL extends DomElement {
	...
	@NotNull
	@Required
	GenericAttributeValue<Double> getTHEVALUE();
