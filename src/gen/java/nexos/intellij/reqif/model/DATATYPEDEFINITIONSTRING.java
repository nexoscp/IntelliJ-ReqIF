...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:DATATYPE-DEFINITION-STRING interface.
 */
public interface DATATYPEDEFINITIONSTRING extends DomElement {
	...
	/**
	 * Returns the value of the MAX-LENGTH child.
	 * @return the value of the MAX-LENGTH child.
	 */
	@NotNull
	@Required
