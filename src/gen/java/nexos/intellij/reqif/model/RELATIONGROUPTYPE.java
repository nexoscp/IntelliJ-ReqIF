...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:RELATION-GROUP-TYPE interface.
 */
public interface RELATIONGROUPTYPE extends DomElement {
	...
	/**
	 * Returns the value of the SPEC-ATTRIBUTES child.
	 * @return the value of the SPEC-ATTRIBUTES child.
	 */
	@NotNull
