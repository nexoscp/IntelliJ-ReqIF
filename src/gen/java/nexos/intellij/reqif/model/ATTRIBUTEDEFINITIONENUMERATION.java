...
/**
 * http://www.omg.org/spec/ReqIF/20110401/reqif.xsd:ATTRIBUTE-DEFINITION-ENUMERATION interface.
 */
public interface ATTRIBUTEDEFINITIONENUMERATION extends DomElement {
	...
	/**
	 * Returns the value of the MULTI-VALUED child.
	 * @return the value of the MULTI-VALUED child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<Boolean> getMULTIVALUED();


	/**
	 * Returns the value of the DEFAULT-VALUE child.
	 * @return the value of the DEFAULT-VALUE child.
	 */
	@NotNull
